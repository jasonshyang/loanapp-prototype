    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('BORROWER', 'Borrower'), ('LENDER', 'Lender')], max_length=20)),
                ('account_state', models.CharField(choices=[('ACTIVE', 'Active'), ('SUSPENDED', 'Suspended'), ('CLOSED', 'Closed')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.CharField(choices=[('ST', 'Student'), ('EM', 'Employed'), ('SE', 'Self Employed'), ('UE', 'Unemployed')], max_length=2)),
                ('risk_score', models.IntegerField(blank=True, null=True)),
                ('risk_level', models.CharField(choices=[('H', 'High'), ('M', 'Medium'), ('L', 'Low')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('risk_appetite', models.CharField(choices=[('H', 'High'), ('M', 'Medium'), ('L', 'Low')], max_length=10)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='accounts.account')),
            ],
